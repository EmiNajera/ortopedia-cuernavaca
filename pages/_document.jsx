  ...
  return (
    <Html lang="es">
      <Head>
        ...
        <link rel="icon" type="image/png" sizes="32x32" href="/images/banners/Ortopedia Cuernavaca Logo.png" />
        <link rel="icon" type="image/png" sizes="16x16" href="/images/banners/Ortopedia Cuernavaca Logo.png" />
