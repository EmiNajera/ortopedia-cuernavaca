    ...
    <div className="container mx-auto py-6 sm:py-8 px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
        ...
        <div className="space-y-3 sm:space-y-4">
          {/* Vista Desktop: Imagen Principal Grande */}
          <div className="hidden sm:block aspect-square bg-gray-100 rounded-lg overflow-hidden shadow-sm relative group">
            <Image
              src={
          ...
          {/* Vista Móvil: Carrusel Swipeable con Snap */}
          <div className="sm:hidden w-full -mx-4 px-4">
            <div className="flex overflow-x-auto snap-x snap-mandatory gap-4 pb-4 mobile-scroll">
              {product.images && product.images.length > 0 ? (
                product.images.map((image, index) => (
                  <div
                    key={index}
                    className="snap-center shrink-0 w-[85vw] aspect-square bg-gray-50 rounded-2xl overflow-hidden relative shadow-sm border border-gray-100"
                  >
                    <Image
                      src={image}
                ...
                <div className="snap-center shrink-0 w-[85vw] aspect-square bg-gray-50 rounded-2xl overflow-hidden relative">
                  <Image
            ...
            {product.images && product.images.length > 1 && (
              <div className="flex justify-center gap-2 mt-2">
                {product.images.map((_, index) => (
                  <div
                    key={index}
                    className={`h-1.5 rounded-full transition-all duration-300 ${index === 0 ? 'w-6 bg-blue-600' : 'w-1.5 bg-gray-300'}`}
                  />
                ))}
              </div>
            )}
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          {/* Cantidad y botones - Sticky en móvil */}
          <div
            className="fixed bottom-0 left-0 right-0 p-4 bg-white border-t border-gray-200 sm:static sm:bg-transparent sm:border-0 sm:p-0 z-40"
          ...
          {/* Espaciador para compensar el sticky footer en móvil */}
