...
const ProfessionalBlogLayout = ({ posts = [], categories = [] }) => {
  const POSTS_PER_PAGE = 12; // Artículos por página
  ...
  return (
    ...
    >
      ...
      <div className="sticky top-0 z-40 bg-white/95 dark:bg-gray-900/95 backdrop-blur-lg border-b border-gray-200/50 dark:border-gray-700/50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
            {/* Enhanced Search */}
            <motion.div
              className={`relative transition-all duration-300 w-full sm:flex-1 sm:min-w-[200px] ${
            ...
            >
              ...
              <input
                ...
                className="w-full pl-10 sm:pl-12 pr-3 sm:pr-4 py-2.5 sm:py-2 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg sm:rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-300 text-sm sm:text-base"
              />
              {searchTerm && (
                <motion.div
                  initial={{ scale: 0 }}
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto justify-center sm:justify-end">
              <div className="flex items-center bg-gray-100 dark:bg-gray-800 rounded-lg p-1">
                <motion.button
                  ...
                  className={`p-2 rounded-md transition-all duration-200 min-h-[44px] min-w-[44px] ${
                    viewMode === 'grid'
              ...
              <motion.button
                ...
                className="p-2 rounded-lg bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-all duration-300 min-h-[44px] min-w-[44px]"
              >
      ...
      <section
        id="hero-blog"
        aria-labelledby="hero-blog-heading"
        ref={heroRef}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <motion.div variants={itemVariants} className="mb-6 sm:mb-8">
              <motion.div
                whileHover={{ scale: 1.05 }}
                className="inline-flex items-center px-4 sm:px-6 py-2 sm:py-3 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-full border border-gray-200/50 dark:border-gray-700/50 mb-6 sm:mb-8"
              >
              ...
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-600 dark:text-gray-300 mb-8 sm:mb-10 lg:mb-12 leading-relaxed max-w-4xl mx-auto px-4">
      ...
      <section
        id="categorias-blog"
        aria-labelledby="categorias-blog-heading"
        className="py-8 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm border-b border-gray-200/50 dark:border-gray-700/50"
      >
      ...
      {featuredPost && (
        <section
          ...
          aria-labelledby="articulo-destacado-heading"
                ...
                <div className="grid lg:grid-cols-2 gap-0">
                  <div className="relative h-80 lg:h-full overflow-hidden">
                    <Image
                      ...
                      alt={`${featuredPost.title} - Artículo destacado: ${featuredPost.excerpt.substring(0, 100)}...`}
                      fill
      ...
      {/* Blog Posts Grid */}
      <section id="articulos-blog" aria-labelledby="articulos-blog-heading" className="py-20">
        <div className="container mx-auto px-6">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
