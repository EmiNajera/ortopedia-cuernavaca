    ...
    <div className="bg-white font-sans">
      ...
      <nav className="bg-gray-200 py-2 px-4 md:px-8 border-t border-b border-gray-300">
        <div className="container mx-auto flex justify-center items-center space-x-4 md:space-x-6 text-sm font-semibold text-blue-900 overflow-x-auto whitespace-nowrap">
          ...
          <Link href="/about-us" className="text-green-600 font-bold hover:text-green-700">AboutUs (TEST)</Link>
      ...
      <main className="p-4 md:p-8">
        ...
        <div className="text-xs text-gray-500 mb-6">
          ...
          <span className="mx-1">&gt;</span>
          <Link href="/tienda?categoria=plantillas" className="hover:underline">Plantillas</Link>
          <span className="mx-1">&gt;</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          {/* Product Info */}
          <div>
            <Link href="/tienda?categoria=plantillas" className="text-blue-700 font-semibold text-sm">{producto.marca}</Link>
            ...
            <div className="text-center text-sm text-gray-600">
              <p className="mb-2">Para conocer la disponibilidad del producto ingresa tu <button type="button" className="text-blue-700 underline">código postal</button>.</p>
              <button type="button" className="text-blue-700 underline">Calcula el costo de envío</button>
            </div>
          </div>
        </div>
