    ...
    >
      ...
      <div className="container mx-auto px-6 py-16 lg:py-24 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-12">
          {/* Contenido de texto */}
          <div 
            className="lg:w-2/5 space-y-6 text-center lg:text-left opacity-0 translate-y-2 animate-[fadeIn_.8s_ease-out_.2s_forwards]"
          >
            <h1 
            ...
            <p 
               className="text-lg lg:text-xl text-gray-700 opacity-0 translate-y-2 animate-[fadeIn_.8s_ease-out_.6s_forwards]"
            >
            ...
            <div 
              className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start opacity-0 translate-y-2 animate-[fadeIn_.8s_ease-out_.8s_forwards]"
            >
              <button 
                className="bg-blue-600 text-white px-6 py-3 rounded-lg uppercase text-sm font-medium transition-colors shadow-lg hover:shadow-xl hover:bg-blue-700"
              >
                Agendar Consulta
              </button>
              <button 
                className="border-2 border-blue-600 text-blue-600 px-6 py-3 rounded-lg uppercase text-sm font-medium transition-colors shadow-lg hover:shadow-xl hover:bg-blue-600 hover:text-white"
              >
                Ver Productos
              </button>
            </div>
            <div 
               className="flex flex-wrap justify-center lg:justify-start gap-6 mt-8 opacity-0 translate-y-2 animate-[fadeIn_.8s_ease-out_1s_forwards]"
            >
          ...
          <div 
            className="lg:w-3/5 flex justify-center opacity-0 translate-y-2 animate-[fadeIn_.8s_ease-out_.4s_forwards]"
          >
            <div 
              className="relative w-full max-w-2xl h-80 md:h-96 lg:h-[32rem] rounded-2xl overflow-hidden cursor-pointer shadow-2xl transition-transform duration-300 hover:scale-[1.02] hover:shadow-[0_25px_50px_rgba(0,0,0,0.2)]"
            >
                  ...
                  <div className="relative space-y-3 w-full">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-1">
                        <span className="text-xs text-gray-500 group-hover:text-blue-500 transition-colors">Ver más</span>
          ...
          {content[activeTab].features.map((feature, index) => (
            ...
            >
              ...
              <div className="p-5 flex flex-col flex-grow">
                <h4 className="font-bold text-gray-900 mb-3 text-lg leading-tight">{feature.title}</h4>
                ...
                {/* Enhanced Modal/Slide-over Panel */}
        <AnimatePresence>
          {selectedFeature && (
            <>
              {/* Backdrop */}
              ...
              >
                <div 
                  className="bg-white/90 backdrop-blur-xl rounded-2xl shadow-2xl max-w-4xl w-full max-h-[88vh] overflow-y-auto scrollbar-thin scrollbar-thumb-blue-200 scrollbar-track-transparent flex flex-col border border-blue-100"
                  role="dialog"
                  aria-modal="true"
                ...
                >
                  ...
                  <div className="relative h-48 sm:h-56 md:h-64 lg:h-72 flex-shrink-0">
                    ...
                    <div className="absolute bottom-0 left-0 p-5 md:p-6">
                      <h2 id="modal-title" className="text-2xl md:text-3xl font-extrabold text-white leading-tight drop-shadow-lg">
                  ...
                  <div className="p-4 sm:p-5 lg:p-6 bg-white/70">
                    ...
                    >
                      ...
                      {selectedFeature.longDescription.split('\n\n').map((paragraph, index) => (
                        <motion.p 
                          key={index} 
                            initial={{ opacity: 0, y: 20 }}
                          animate={{ opacity: 1, y: 0 }}
                    ...
                    >
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                        {[
                          { step: '1', title: 'Evaluación Inicial', desc: 'Análisis completo de tu condición y necesidades específicas' },
                          { step: '2', title: 'Diseño Personalizado', desc: 'Creación de un plan de tratamiento adaptado a ti' },
                          { step: '3', title: 'Aplicación del Tratamiento', desc: 'Implementación del protocolo con supervisión especializada' },
                          { step: '4', title: 'Seguimiento Continuo', desc: 'Monitoreo del progreso y ajustes según sea necesario' }
                        ].map((item, index) => (
                          <motion.div
                            key={index}
                          ...
                          >
                            ...
                            <div className="min-w-0 flex-1">
                              <h4 className="font-semibold text-gray-900 mb-0.5 text-sm">{item.title}</h4>
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4">
                        ...
                        <div className="bg-gradient-to-br from-purple-50 to-violet-50 rounded-xl p-4 border border-purple-100">
                          ...
                          <div className="space-y-2">
                            {[
                              { label: 'Duración del Tratamiento', value: 'Varía según la condición' },
                              { label: 'Sesiones Requeridas', value: 'Personalizadas según necesidades' },
                              ...
                              >
                                ...
                                <span className="text-xs text-purple-600 font-semibold">{spec.value}</span>
                              </motion.div>
                            ))}
                          </div>
                        </div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                        {[
                          ...
                          >
                            ...
                            <h4 className="font-semibold text-gray-900 mb-0.5 text-sm">{contact.title}</h4>
                    ...
                    >
                      <div className="text-center">
                        <p className="text-sm text-gray-600 mb-3">¿Te interesa este servicio? Agenda tu cita.</p>
                      <motion.button 
                        onClick={() => {
                          setSelectedFeature(null);
                            openWhatsApp(`Hola, me gustaría obtener más información sobre el servicio: \"${selectedFeature.title}\".`);
                          }}
...
function FeaturedServices() {
  ...
  const services = [
    ...
    { 
      ...
      description: 'Dispositivos para estabilización y protección articular con materiales de última generación',
      category: 'Ortesis'
    },
    { 
    ...
    <section className="bg-gradient-to-br from-gray-100 via-gray-50 to-blue-50 py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="text-center mb-12">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Nuestros Servicios Destacados</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            >
              ...
              <div className="p-6">
                    ...
                    <button className="text-sm font-semibold flex items-center text-blue-600 hover:text-blue-700 transition-colors group">
                      Más Información <ChevronRightIcon className="ml-2 transition-transform group-hover:translate-x-1" />
                </button>
              </div>
                </motion.div>
              ))}
