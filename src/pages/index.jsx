  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="OrtoTech | Ortopedia Cuernavaca: Soluciones integrales en rehabilitación física y ortopedia. Te acompañamos desde el diagnóstico hasta la recuperación." />
        ...
        <div className="relative">
          ...
          >
            ...
            <div className="relative z-10 p-6 max-w-6xl mx-auto">
              ...
              <div className="mt-10 flex flex-col sm:flex-row justify-center gap-6 fade-in" style={{ animationDelay: "1s" }}>
                <button 
            ...
            >
              <div className="flex flex-col items-center opacity-90 hover:opacity-100 transition-opacity">
                ...
                >
                  <path d="M1 1L15 13L29 1" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </div>
            </button>
          </section>
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center p-8 z-10">
                    <div className="text-center max-w-5xl mx-auto">
                      ...
                      <div className="flex items-center justify-center mb-8">
                        ...
                        <div className="mx-4 text-white/80 text-sm uppercase tracking-widest font-light">Experiencia Integral</div>
                        <div className="h-px w-12 bg-white/30"></div>
                      </div>
                      ...
                      <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto mb-10 font-light leading-relaxed">
                        Órtesis, prótesis, plantillas personalizadas y fisioterapia. Todo lo que necesitas para tu recuperación en un solo lugar.
                      </p>
      ...
      <section id="rehabilitacion" className="py-24 bg-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Selecciona el área que te interesa y descubre cómo podemos ayudarte en tu proceso de recuperación.
                      ...
                      <div className="flex flex-wrap justify-center gap-4 mb-12" role="tablist" aria-label="Categorías de servicios de rehabilitación" aria-orientation="horizontal">
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-xl transform hover:scale-102 transition-all duration-500 bg-gradient-to-b from-gray-50 to-white" role="tabpanel" id={`tabpanel-${activeIndex}`} aria-labelledby={`tab-${activeIndex}`}>
