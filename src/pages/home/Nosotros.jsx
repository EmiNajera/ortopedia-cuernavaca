          ...
          <div className="container mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6 opacity-0 translate-y-2 animate-[fadeIn_.8s_ease-out_.2s_forwards]">
                <h1 className="text-4xl lg:text-5xl font-extrabold leading-tight text-gray-800 opacity-0 translate-y-2 animate-[fadeIn_.8s_ease-out_.4s_forwards]">
                  30 AÑOS
                  <br />
                ...
                <p className="text-lg text-gray-600 leading-relaxed opacity-0 translate-y-2 animate-[fadeIn_.8s_ease-out_.6s_forwards]">
                  De la experiencia clínica a la tecnología de vanguardia para tu movilidad,
                ...
                >
                  ...
                  <div className="bg-white p-8 rounded-xl shadow-lg border-l-4 border-blue-600">
                    <p className="text-lg text-gray-700 leading-relaxed mb-6">
                      En{' '}
                      <strong className="text-blue-600 font-semibold">Ortopedia Cuernavaca</strong>{' '}
                      somos un{' '}
                      <strong className="text-gray-800">
                        Centro Integral de Rehabilitación Física
                      </strong>{' '}
                      con más de <strong className="text-blue-600">30 años de experiencia</strong>{' '}
                      ayudando a las personas a recuperar su movilidad, mejorar su postura y
                    ...
                    <p className="text-lg text-gray-700 leading-relaxed mb-6">
                      ...
                      modelo único que une la tradición clínica con la innovación tecnológica.
                      Creemos que la rehabilitación no es solo un tratamiento, sino un{' '}
                    ...
                    <p className="text-lg text-gray-700 leading-relaxed">
                      ...
                      especialistas en ortopedia, fisioterapia y rehabilitación que trabajan de
                      manera coordinada para ofrecer un servicio integral.
                    </p>
                  </div>
                </motion.div>
              </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <div className="space-y-4 text-gray-700">
                  ...
                  <p>
                    Así, en 1995, nació Ortopedia Cuernavaca, un pequeño taller con una visión
                    clara: ofrecer atención profesional y humana a quienes enfrentaban limitaciones
                    físicas, dolor crónico o amputaciones. En esos primeros años, se fabricaban
                    plantillas, se adaptaban prótesis y se atendían casos de todo tipo con recursos
                    modestos pero con un compromiso total con cada persona que llegaba en busca de
                    ayuda.
                  </p>
                  <p>
                  ...
                  <p>
                    Ese crecimiento nos llevó a abrir una segunda sucursal: Ortochavitos, enfocada
                    en el área pediátrica y la comercialización de productos ortopédicos. Hoy, tras
                    tres décadas de trabajo continuo, somos un referente regional en ortopedia y
                    rehabilitación física, con un legado construido sobre valores sólidos,
                    tecnología innovadora y una convicción firme: cambiar vidas devolviendo
                    movilidad, confianza y bienestar a nuestros pacientes.
                  </p>
                </div>
              </div>
              <div>
            ...
            <div className="text-center mb-16">
              ...
              >
                ...
                <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
                  Una presentación fluida de nuestros principios fundamentales que guían cada
                  decisión y cada tratamiento que realizamos.
                </p>
              </motion.div>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
              ...
              >
                ...
                <div className="text-sm text-gray-600 mt-2">
                  Soluciones personalizadas y humanas
                </div>
              </motion.div>
                    ...
                    <div className="w-1/2 pr-8 text-right">
                      <div className="bg-white p-4 rounded-lg shadow-md">
                        ...
                        <div className="text-sm text-gray-600 mt-1">
                          Nace el primer espacio especializado en soluciones ortopédicas de la
                          ciudad
                        </div>
                      </div>
                    </div>
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              >
                ...
                <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
                  Espacios diseñados para brindar la mejor atención y comodidad a nuestros
                  pacientes.
                </p>
              </motion.div>
            </div>
          ...
          <div className="container mx-auto px-6 text-center">
            ...
            >
              ...
              <p className="text-xl mb-8 max-w-3xl mx-auto leading-relaxed">
                ...
                recuperar su independencia, o a una persona con amputación sonreír al dar sus
                primeros pasos con una prótesis personalizada.
              </p>
              <p className="text-lg mb-8 max-w-3xl mx-auto leading-relaxed">
                Tu movilidad, tu bienestar y tu calidad de vida son nuestra pasión. Desde 1995 y
                hacia el futuro, estamos aquí para caminar contigo.
              </p>
