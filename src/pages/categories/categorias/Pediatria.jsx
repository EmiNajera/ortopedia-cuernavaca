...
export default function Pediatria() {
  ...
  const products = [
    { id: "31", imgSrc: "https://placehold.co/150x150/FF69B4/ffffff?text=Calzado+Infantil+1", description: "Calzado infantil ortopédico", price: "$680.00" },
    { id: "32", imgSrc: "https://placehold.co/150x150/FF1493/ffffff?text=Plantilla+Infantil+1", description: "Plantilla pediátrica", price: "$450.00" },
    { id: "33", imgSrc: "https://placehold.co/150x150/FFB6C1/ffffff?text=Férula+Infantil+1", description: "Férula infantil", price: "$580.00" },
    { id: "34", imgSrc: "https://placehold.co/150x150/FFC0CB/ffffff?text=Ortesis+Infantil+1", description: "Ortesis pediátrica", price: "$720.00" },
    { id: "35", imgSrc: "https://placehold.co/150x150/FF69B4/ffffff?text=Producto+Infantil+1", description: "Producto para bebés", price: "$380.00" },
    { id: "151", imgSrc: "https://placehold.co/150x150/FF1493/ffffff?text=Calzado+Infantil+2", description: "Zapatos para niños especiales", price: "$550.00" },
    { id: "152", imgSrc: "https://placehold.co/150x150/FFB6C1/ffffff?text=Plantilla+Infantil+2", description: "Plantillas para adolescentes", price: "$420.00" },
    { id: "153", imgSrc: "https://placehold.co/150x150/FFC0CB/ffffff?text=Ortesis+Infantil+2", description: "Ortesis para desarrollo", price: "$650.00" }
  ];
  ...
  const getFilteredAndSortedProducts = () => {
    ...
    switch (sortBy) {
      case 'price-asc':
        return filtered.sort((a, b) => parseFloat(a.price.replace('$', '').replace(',', '')) - parseFloat(b.price.replace('$', '').replace(',', '')));
      case 'price-desc':
        return filtered.sort((a, b) => parseFloat(b.price.replace('$', '').replace(',', '')) - parseFloat(a.price.replace('$', '').replace(',', '')));
      case 'name':
  ...
  return (
    <Layout>
      <div className="container mx-auto py-8 px-4">
        ...
        <div className="bg-pink-500 text-white p-8 rounded-lg mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-4xl font-bold mb-4">👶 Ortopedia Pediátrica</h1>
              <p className="text-xl opacity-90 mb-4">
                Productos especializados para niños y adolescentes. 
                Calzado infantil, plantillas pediátricas y férulas para el desarrollo saludable.
              </p>
        ...
        <div className="bg-gray-50 rounded-lg p-6 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">¿Por qué elegir nuestros productos pediátricos?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="text-3xl mb-2">👶</div>
              <h3 className="font-semibold mb-2">Especializado</h3>
              <p className="text-gray-600">Diseñado específicamente para niños</p>
            </div>
            <div className="text-center">
              <div className="text-3xl mb-2">🌱</div>
              <h3 className="font-semibold mb-2">Desarrollo</h3>
              <p className="text-gray-600">Favorece el desarrollo saludable</p>
            </div>
            <div className="text-center">
              <div className="text-3xl mb-2">🛡️</div>
              <h3 className="font-semibold mb-2">Seguro</h3>
              <p className="text-gray-600">Materiales seguros para niños</p>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div className="flex items-center gap-4 flex-1">
              <div className="relative flex-1 max-w-md">
                <input
                  type="text"
                  placeholder="Buscar productos pediátricos..."
                  value={searchTerm}
        ...
        <div className="mt-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            ...
            <Link href="/categoria/fajas" className="bg-green-500 text-white p-4 rounded-lg text-center hover:shadow-lg transition-all duration-300 transform hover:scale-105">
              <div className="text-2xl mb-2">🩹</div>
