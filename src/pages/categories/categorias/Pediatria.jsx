...
export default function Pediatria() {
  ...
  const products = [
    {
      id: '31',
      imgSrc: 'https://placehold.co/150x150/FF69B4/ffffff?text=Calzado+Infantil+1',
      description: 'Calzado infantil ortopédico',
      price: '$680.00',
    },
    {
      id: '32',
      imgSrc: 'https://placehold.co/150x150/FF1493/ffffff?text=Plantilla+Infantil+1',
      description: 'Plantilla pediátrica',
      price: '$450.00',
    },
    {
      id: '33',
      imgSrc: 'https://placehold.co/150x150/FFB6C1/ffffff?text=Férula+Infantil+1',
      description: 'Férula infantil',
      price: '$580.00',
    },
    {
      id: '34',
      imgSrc: 'https://placehold.co/150x150/FFC0CB/ffffff?text=Ortesis+Infantil+1',
      description: 'Ortesis pediátrica',
      price: '$720.00',
    },
    {
      id: '35',
      imgSrc: 'https://placehold.co/150x150/FF69B4/ffffff?text=Producto+Infantil+1',
      description: 'Producto para bebés',
      price: '$380.00',
    },
    {
      id: '151',
      imgSrc: 'https://placehold.co/150x150/FF1493/ffffff?text=Calzado+Infantil+2',
      description: 'Zapatos para niños especiales',
      price: '$550.00',
    },
    {
      id: '152',
      imgSrc: 'https://placehold.co/150x150/FFB6C1/ffffff?text=Plantilla+Infantil+2',
      description: 'Plantillas para adolescentes',
      price: '$420.00',
    },
    {
      id: '153',
      imgSrc: 'https://placehold.co/150x150/FFC0CB/ffffff?text=Ortesis+Infantil+2',
      description: 'Ortesis para desarrollo',
      price: '$650.00',
    },
  ];
      ...
      <div className="container mx-auto py-8 px-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl opacity-90 mb-4">
                Productos especializados para niños y adolescentes. Calzado infantil, plantillas
                pediátricas y férulas para el desarrollo saludable.
              </p>
        ...
        <div className="bg-gray-50 rounded-lg p-6 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">
            ¿Por qué elegir nuestros productos pediátricos?
          </h2>
