...
export default function Ortesis() {
  ...
  const products = [
    ...
    { id: "121", imgSrc: "https://placehold.co/150x150/E67E22/ffffff?text=Ortesis+1", description: "Ortesis de hombro", price: "$580.00" },
    { id: "122", imgSrc: "https://placehold.co/150x150/95A5A6/ffffff?text=Ortesis+2", description: "Ortesis de cadera", price: "$720.00" },
    { id: "123", imgSrc: "https://placehold.co/150x150/34495E/ffffff?text=Ortesis+3", description: "Ortesis de columna", price: "$890.00" }
  ];
    ...
    <Layout>
      <div className="container mx-auto py-8 px-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl opacity-90 mb-4">
                Ortesis para rodillas, tobillos y otras articulaciones. 
                Soporte especializado para recuperación y prevención de lesiones.
              </p>
        ...
        <div className="bg-gray-50 rounded-lg p-6 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">¿Por qué elegir nuestras ortesis?</h2>
