...
export default function Fajas() {
  ...
  const products = [
    ...
    { id: "111", imgSrc: "https://placehold.co/150x150/2ECC71/ffffff?text=Faja+6", description: "Faja para hernia", price: "$680.00" },
    { id: "112", imgSrc: "https://placehold.co/150x150/3498DB/ffffff?text=Faja+7", description: "Faja postoperatoria", price: "$920.00" },
    { id: "113", imgSrc: "https://placehold.co/150x150/8E44AD/ffffff?text=Faja+8", description: "Faja de compresión", price: "$550.00" }
  ];
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl opacity-90 mb-4">
                Fajas ortopédicas para diferentes partes del cuerpo. 
                Soporte lumbar, abdominal, torácico y pélvico para tu bienestar.
              </p>
