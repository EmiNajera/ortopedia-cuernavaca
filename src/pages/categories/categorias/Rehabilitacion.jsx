...
export default function Rehabilitacion() {
  ...
  const products = [
    {
      id: '26',
      imgSrc: 'https://placehold.co/150x150/E74C3C/ffffff?text=Masajeador+1',
      description: 'Masajeador eléctrico',
      price: '$450.00',
    },
    {
      id: '27',
      imgSrc: 'https://placehold.co/150x150/9B59B6/ffffff?text=Masajeador+2',
      description: 'Masajeador de cuello',
      price: '$380.00',
    },
    {
      id: '28',
      imgSrc: 'https://placehold.co/150x150/3498DB/ffffff?text=Electroestimulador',
      description: 'Electroestimulador TENS',
      price: '$650.00',
    },
    {
      id: '29',
      imgSrc: 'https://placehold.co/150x150/2ECC71/ffffff?text=Equipo+1',
      description: 'Equipo de fisioterapia',
      price: '$1,200.00',
    },
    {
      id: '30',
      imgSrc: 'https://placehold.co/150x150/F39C12/ffffff?text=Equipo+2',
      description: 'Equipo de rehabilitación',
      price: '$980.00',
    },
    {
      id: '141',
      imgSrc: 'https://placehold.co/150x150/1ABC9C/ffffff?text=Terapia+1',
      description: 'Equipo de terapia ocupacional',
      price: '$750.00',
    },
    {
      id: '142',
      imgSrc: 'https://placehold.co/150x150/34495E/ffffff?text=Terapia+2',
      description: 'Equipo de terapia respiratoria',
      price: '$580.00',
    },
    {
      id: '143',
      imgSrc: 'https://placehold.co/150x150/8E44AD/ffffff?text=Terapia+3',
      description: 'Equipo de terapia manual',
      price: '$420.00',
    },
  ];
      ...
      <div className="container mx-auto py-8 px-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl opacity-90 mb-4">
                Equipos y productos para rehabilitación y fisioterapia. Masajeadores,
                electroestimuladores y equipos de terapia especializados.
              </p>
        ...
        <div className="bg-gray-50 rounded-lg p-6 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">
            ¿Por qué elegir nuestros equipos de rehabilitación?
          </h2>
