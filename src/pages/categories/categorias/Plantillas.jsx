...
export default function Plantillas() {
  ...
  const products = [
    ...
    { id: "101", imgSrc: "https://placehold.co/150x150/E74C3C/ffffff?text=Plantilla+7", description: "Plantilla para diabéticos", price: "$680.00" },
    { id: "102", imgSrc: "https://placehold.co/150x150/F39C12/ffffff?text=Plantilla+8", description: "Plantilla para corredores", price: "$590.00" }
  ];
    ...
    <Layout>
      <div className="container mx-auto py-8 px-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl opacity-90 mb-4">
                Plantillas personalizadas para diferentes tipos de pie y actividades. 
                Soluciones especializadas para mejorar tu postura y confort.
              </p>
        ...
        <div className="bg-gray-50 rounded-lg p-6 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">¿Por qué elegir nuestras plantillas?</h2>
