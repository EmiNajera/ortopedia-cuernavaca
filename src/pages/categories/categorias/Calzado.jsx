...
export default function Calzado() {
  ...
  const products = [
    { id: "21", imgSrc: "https://placehold.co/150x150/E67E22/ffffff?text=Zapato+1", description: "Zapato para diabéticos", price: "$1,200.00" },
    { id: "22", imgSrc: "https://placehold.co/150x150/95A5A6/ffffff?text=Zapato+2", description: "Zapato post-operatorio", price: "$980.00" },
    { id: "23", imgSrc: "https://placehold.co/150x150/34495E/ffffff?text=Zapato+3", description: "Zapato deportivo ortopédico", price: "$850.00" },
    { id: "24", imgSrc: "https://placehold.co/150x150/16A085/ffffff?text=Zapato+4", description: "Zapato de trabajo", price: "$750.00" },
    { id: "25", imgSrc: "https://placehold.co/150x150/2980B9/ffffff?text=Zapato+5", description: "Zapato casual ortopédico", price: "$680.00" },
    { id: "131", imgSrc: "https://placehold.co/150x150/8E44AD/ffffff?text=Zapato+6", description: "Zapato para pie plano", price: "$920.00" },
    { id: "132", imgSrc: "https://placehold.co/150x150/27AE60/ffffff?text=Zapato+7", description: "Zapato para pie cavo", price: "$1,050.00" },
    { id: "133", imgSrc: "https://placehold.co/150x150/E74C3C/ffffff?text=Zapato+8", description: "Zapato de seguridad", price: "$1,350.00" }
  ];
      ...
      <div className="container mx-auto py-8 px-4">
        ...
        <div className="bg-orange-500 text-white p-8 rounded-lg mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-4xl font-bold mb-4">👟 Calzado Ortopédico</h1>
              <p className="text-xl opacity-90 mb-4">
                Zapatos y calzado especializado para diferentes necesidades. 
                Calzado para diabéticos, post-operatorio y deportivo.
              </p>
              <div className="flex items-center space-x-4 text-sm">
                <span>📦 {products.length} productos</span>
                <span>⭐ 4.6/5 calificación</span>
        ...
        <div className="bg-gray-50 rounded-lg p-6 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">¿Por qué elegir nuestro calzado?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="text-3xl mb-2">🦶</div>
              <h3 className="font-semibold mb-2">Especializado</h3>
              <p className="text-gray-600">Diseñado para condiciones específicas</p>
            </div>
            <div className="text-center">
              <div className="text-3xl mb-2">🛡️</div>
              <h3 className="font-semibold mb-2">Protección</h3>
              <p className="text-gray-600">Protege y cuida tus pies</p>
            </div>
            <div className="text-center">
              <div className="text-3xl mb-2">😌</div>
              <h3 className="font-semibold mb-2">Confort</h3>
              <p className="text-gray-600">Máximo confort durante todo el día</p>
            </div>
          </div>
        </div>
