...
export default function Calzado() {
  ...
  const products = [
    ...
    {
      id: '22',
      imgSrc: 'https://placehold.co/150x150/95A5A6/ffffff?text=Zapato+2',
      description: 'Zapato post-operatorio',
      price: '$980.00',
    },
    {
      id: '23',
      imgSrc: 'https://placehold.co/150x150/34495E/ffffff?text=Zapato+3',
      description: 'Zapato deportivo ortopédico',
      price: '$850.00',
    },
    {
      id: '24',
      imgSrc: 'https://placehold.co/150x150/16A085/ffffff?text=Zapato+4',
      description: 'Zapato de trabajo',
      price: '$750.00',
    },
    {
      id: '25',
      imgSrc: 'https://placehold.co/150x150/2980B9/ffffff?text=Zapato+5',
      description: 'Zapato casual ortopédico',
      price: '$680.00',
    },
    {
      id: '131',
      imgSrc: 'https://placehold.co/150x150/8E44AD/ffffff?text=Zapato+6',
      description: 'Zapato para pie plano',
      price: '$920.00',
    },
    {
      id: '132',
      imgSrc: 'https://placehold.co/150x150/27AE60/ffffff?text=Zapato+7',
      description: 'Zapato para pie cavo',
      price: '$1,050.00',
    },
    {
      id: '133',
      imgSrc: 'https://placehold.co/150x150/E74C3C/ffffff?text=Zapato+8',
      ...
      <div className="container mx-auto py-8 px-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl opacity-90 mb-4">
                Zapatos y calzado especializado para diferentes necesidades. Calzado para
                diabéticos, post-operatorio y deportivo.
              </p>
        ...
        <div className="bg-gray-50 rounded-lg p-6 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">
            ¿Por qué elegir nuestro calzado?
          </h2>
