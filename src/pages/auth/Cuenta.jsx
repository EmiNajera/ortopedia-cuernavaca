  ...
  const orders = [
    {
      ...
      total: 1250.0,
      items: [
        { name: 'Plantillas ortopédicas personalizadas', quantity: 1, price: 850.0 },
        { name: 'Faja lumbar de soporte', quantity: 1, price: 400.0 },
      ],
    },
    {
      id: 'ORD-002',
      ...
      total: 750.0,
      items: [
        { name: 'Rodillera deportiva', quantity: 1, price: 450.0 },
        { name: 'Bastón ajustable', quantity: 1, price: 300.0 },
      ],
    },
    {
      id: 'ORD-003',
      ...
      status: 'Entregado',
      total: 1800.0,
      items: [{ name: 'Calzado ortopédico', quantity: 1, price: 1800.0 }],
    },
  ];
                    ...
                    <div className="bg-white rounded-xl shadow-lg p-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center p-4 bg-gray-50 rounded-lg">
                          ...
                          <div className="flex-1">
                            <p className="text-sm font-medium text-gray-900">
                              Cita confirmada para el 25 de enero
                            </p>
