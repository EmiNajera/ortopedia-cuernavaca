-- Script para crear tabla de categorías normalizadas e insertar las 25 categorías
...
-- Verificar inserción
SELECT COUNT(*) as total_categorias FROM categorias_normalizadas;
SELECT slug, nombre, orden FROM categorias_normalizadas ORDER BY orden;
